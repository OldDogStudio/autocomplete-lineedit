...
* This addon add a minimum character feature. If that is the only positive to using this addon, Lamelynx has a fork of Lenrow's addon with the minimum character feature.  
